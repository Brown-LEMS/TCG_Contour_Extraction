function  [G, merged_cem, merged_cf_idx, T_junctions] = merge_cfrags_graphical_model(new_cfrags, new_cfrags_idx, edges, hsv_img, tmap, edgemap, params)    
