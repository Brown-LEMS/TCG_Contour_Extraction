...
src_path = '/media/guoy/Research/Datasets/VOCdevkit/VOC2007/JPEGImages/';
seg_path = '/media/guoy/Research/Datasets/VOCdevkit/VOC2007/SegmentationObject/';
% src_path = 'Data/CUB14/all_imgs/';
img_files = dir([seg_path '*.png']);
out_path = '/media/guoy/Research/Project_contour/MSEL_contour_extraction_full/Data/VOC2007/VOC2007_SE/edges/';
mkdir(out_path);
