...
imgPath  = '/media/guoy/Research/Datasets/MiddEval/trainingQ/';
src_path = '/media/guoy/Research/Datasets/MiddEval/trainingQ_SE/';
% edgePath = '../../data/CFGD/Pb/';
outPath = '/media/guoy/Research/Datasets/MiddEval/trainingQ_SE/results_ucm/';
...
%     E =  imresize(ucms(:,:,1), [h,w])>th;
    ...
    for c = 1:length(edgelist2)
        ...
        edgelist2{c}(:,1)= (edgelist2{c}(:,1)/2)-1;
        edgelist2{c}(:,2)= (edgelist2{c}(:,2)/2)-1;

    end

    % change coordinates to original size
    edginfo(:,1) = (edginfo(:,1)/2)-1;
    edginfo(:,2) = (edginfo(:,2)/2)-1;
