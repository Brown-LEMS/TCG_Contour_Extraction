...
src_path = '/media/guoy/Research/Datasets/3D_Drawing/pavilion-midday-mcs-work/SE_edges/';
% edgePath = '../../data/CFGD/Pb/';
outPath = '/media/guoy/Research/Datasets/3D_Drawing/pavilion-midday-mcs-work/SE_ucm/';
...
%     write_cem_fixed_edge_id(cem_file, edgelist2, edginfo,  size(im,1), size(im,2), cfrags_idx)
    det_save_cemv(cem_file, edgelist2);
