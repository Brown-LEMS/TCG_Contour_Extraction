...
imgPath  = '/media/New_Volume/Research/Project_contour/SEL_release/Data/VOC2007_img/';
gPb_path = '/media/New_Volume/Research/Project_contour/SEL_release/Data/gPb_SEL_VOC2007/edges/';
% edgePath = '../../data/CFGD/Pb/';
outPath = '/media/New_Volume/Research/Project_contour/SEL_release/Data/gPb_Kovesi_VOC2007/';
...
for iI= 1:numImage
    disp([num2str(iI) '/' num2str(numImage)]);
    tic
