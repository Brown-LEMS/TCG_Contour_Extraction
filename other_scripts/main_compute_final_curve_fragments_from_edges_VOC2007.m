...
%% set paths
edge_src_path = 'Data/gPb_SEL_VOC2007/edges/';
cfrags_dst_path = 'Data/gPb_SEL_VOC2007/cfrags/';
mkdir(cfrags_dst_path);
img_src_path = 'Data/VOC2007_img/';
cem_src_path = cfrags_dst_path;
final_cem_path = 'Data/gPb_SEL_VOC2007/final_curves/';
...
%     print([final_cem_path img_files(c).name(1:end-4) '.png'], '-dpng')
    H = figure(1);
