...
cem_src_path = '/media/guoy/Research/Project_contour/MSEL_contour_extraction_full/Data/VOC2007/VOC2007_gPb_Maruthi/gPb_TCG_VOC2007/';
final_cem_path = '/media/guoy/Research/Project_contour/MSEL_contour_extraction_full/Data/VOC2007/VOC2007_gPb_Maruthi/gPb_TCG_VOC2007/Top50/';
...
for c = 51:length(img_files)
    ...
    [~, edgemap, thetamap] = load_edg([edge_src_path img_files(c).name(1:end-4) '_gpb.edg']);
