...
%% set paths
base_src_path = '/media/guoy/Research/Project_contour/MSEL_contour_extraction_full/Data/VOC2007/VOC2007_gPb_Maruthi/';
edge_src_path = [base_src_path 'edges/'];
cfrags_dst_path = [base_src_path 'gPb_MSEL_VOC2007/'];
