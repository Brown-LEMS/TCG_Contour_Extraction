...
%     [~, edgemap1, thetamap1] = load_edg([cem_path image_names{i} '/im1.edg']);
    ...
    %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%     cfrags0 = CEM0{2};
    for ii = 1:length(cfrags_maps0)
        if(length(cfrags_maps0{ii})>num_th)
            cfrags0 = cfrags_maps0{ii};
            break;
        end
    end
...
%     cfrags0 = cfrags0(sort_id);
    ...
    %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%     cfrags1 = CEM1{2};
    for ii = 1:length(cfrags_maps1)
        if(length(cfrags_maps1{ii})>num_th)
            cfrags1 = cfrags_maps1{ii};
            break;
        end
    end
...
%     cfrags_trans01 = CEM01{2};
    for ii = 1:length(cfrags_maps01)
        if(length(cfrags_maps01{ii})>num_th)
            cfrags_trans01 = cfrags_maps01{ii};
            break;
        end
    end
...
%     cfrags_trans10 = CEM10{2};
    for ii = 1:length(cfrags_maps10)
        if(length(cfrags_maps10{ii})>num_th)
            cfrags_trans10 = cfrags_maps10{ii};
            break;
        end
    end
