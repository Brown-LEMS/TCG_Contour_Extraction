...
eval_file1 = '/media/guoy/Research/Datasets/MiddEval/trainingQ_COB_ucm_eval.mat';
eval_file2 = '/media/guoy/Research/Datasets/MiddEval/trainingQ_COB_MSEL_eval.mat';
eval_file3 = '/media/guoy/Research/Datasets/MiddEval/trainingQ_SE_MSEL_eval.mat';
% eval_file4 = '/media/guoy/Research/Datasets/Drapery_Datasets/Cloth1_GE_MSEL_eval.mat';
out_file = '/media/guoy/Research/Datasets/MiddEval/trainingQ_COB_eval_all';
...
ylabel('Precision')
grid on;
legend('COB-ucm', 'COB-MSEL', 'SE-MSEL', 'Location', 'NorthWest')
