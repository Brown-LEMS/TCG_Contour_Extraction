...
img_src_path = '/media/guoy/Research/Project_contour/MSEL_contour_extraction_full/Data/trifocal/img/';
edge_src_path = '/media/guoy/Research/Project_contour/MSEL_contour_extraction_full/Data/trifocal/SE_edges/';
frags_dst_path = '/media/guoy/Research/Project_contour/MSEL_contour_extraction_full/Data/trifocal/SE_TCG/';
final_cem_path = frags_dst_path;
mkdir(frags_dst_path);
%% set parameters
params.vis = 1;
params.DP_gap_range = 20;
params.DP_angle_th = pi/2;
params.DP_contrast_th = 0.05;
params.shape_gap_range = 12;
params.shape_ori_range = pi/4;
params.BP_clen_th = 15;
params.BP_merge_angle_th = pi/9;
params.BP_nbr_num_edges = 20;
params.geom_merge_angle_th = pi/12;
